...
// Properties shared between old and new architecture
RCT_EXPORT_VIEW_PROPERTY(disableCopyPaste, BOOL)
RCT_EXPORT_VIEW_PROPERTY(smartPunctuation, NSString)

#ifdef RCT_NEW_ARCH_ENABLED
// ============================================================================
// New Architecture (Fabric) - Minimal properties
// Event handlers (onChange, onPaste, etc.) are managed by codegen, not by RCT_EXPORT_VIEW_PROPERTY
// mostRecentEventCount is also managed by the React layer, not set as a view property
// ============================================================================
...
#else
// ============================================================================
// Old Architecture (Paper) - Full properties
// ============================================================================
...
// Event handlers for old architecture
