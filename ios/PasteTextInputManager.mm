...
#ifdef RCT_NEW_ARCH_ENABLED
// New Architecture - no module registration needed, Fabric component is registered via PasteTextInputCls()
#endif

#ifndef RCT_NEW_ARCH_ENABLED
// Old Architecture - these properties are handled via the manager
...
#ifndef RCT_NEW_ARCH_ENABLED
// Old Architecture only - properties are handled via the manager
...
// In new architecture, events are handled by the Fabric component itself, not the manager
